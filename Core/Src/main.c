          ...
          if (result == HAL_OK)
          {
              switch (rcvBuf[0])
              {
                  case '1':
                      ...
                      int ledGreenPow = HAL_GPIO_ReadPin(LED_GREEN_GPIO_Port, LED_GREEN_Pin);
                      if(ledGreenPow){
                  ...
                  case '2':
                      ...
                      int ledORANGEPow = HAL_GPIO_ReadPin(LED_ORANGE_GPIO_Port, LED_ORANGE_Pin);
                      if(ledORANGEPow){
                  ...
                  case '3':
                      ...
                      int ledREDPow = HAL_GPIO_ReadPin(LED_RED_GPIO_Port, LED_RED_Pin);
                      if(ledREDPow){
                  ...
                  case '4':
                      ...
                      int ledBLUEPow = HAL_GPIO_ReadPin(LED_BLUE_GPIO_Port, LED_BLUE_Pin);
                      if(ledBLUEPow){
